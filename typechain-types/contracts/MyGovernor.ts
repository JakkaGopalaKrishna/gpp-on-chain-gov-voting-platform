...
export interface MyGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "proposalThresholdTokens",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proposalVotingType",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "qvSpent", data: BytesLike): Result;
...
export interface MyGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): MyGovernor;
  ...
  proposalThresholdTokens: TypedContractMethod<[], [bigint], "view">;
  ...
  proposalVotingType: TypedContractMethod<
    [arg0: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  proposeWithType: TypedContractMethod<
    [
      targets: AddressLike[],
      values: BigNumberish[],
      calldatas: BytesLike[],
  ...
  getFunction(
    nameOrSignature: "proposalThresholdTokens"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "proposalVotingType"
  ...
  >;
  getFunction(
    nameOrSignature: "proposeWithType"
  ): TypedContractMethod<
    [
      targets: AddressLike[],
      values: BigNumberish[],
